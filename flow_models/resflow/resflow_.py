...
from flow_models.resflow.layers import ActNorm2d, SequentialFlow, ActNorm1d, InvertibleLinear, InvertibleConv2d, iResBlock, MovingBatchNorm2d, SqueezeLayer, CouplingBlock, ChannelCouplingBlock, MaskedCouplingBlock
from flow_models.resflow.layers.base import Swish, LipschitzCube, Identity, get_linear, get_conv2d, Sin
...
class ResidualFlow(nn.Module):
    ...
    def forward(self, x, logpx=None, reverse=False, classify=False):
        if reverse:
