    ...
    def forward(self, x, logpx=None):
        ...
        if not self.initialized:
            with torch.no_grad():
                ...
                print('init: ', self.weight.min().item(), self.weight.max().item(), self.weight.mean().item())
        #else:
        ...
        # print('forward: ', self.weight.min().item(), self.weight.max().item(), self.weight.mean().item())
